...
-- 시작 번호를 300, 증가값은 5, 최대값은 310, 순환X, 캐시메모리X
...
/*
            *   시퀀스 사용하기    *
            ...
            -   시퀀스명.CURRVAL    :   현재 시퀀스 값 (마지막으로 성공한 NEXTVAL의 수행한 값 조회)
...
-- 시작값: 300, 증가값: 1, ... 순환여부: NOCYCLE, 최대값: 엄청큼...

--  * 시퀀스 사용하기  :   EMPLOYEE 테이블에 데이터가 추가될 때
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
        VALUES  (SEQ_EID.NEXTVAL, '조건웅', '990729-1111111', 'J4', SYSDATE);
        
SELECT * FROM EMPLOYEE;

INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
        VALUES  (SEQ_EID.NEXTVAL, '조건순', '990729-2111111', 'J4', SYSDATE);
